...
fileUrl <- 'https://raw.githubusercontent.com/atno/ExperimentManager/master/sampleTrain.csv'
download.file(fileUrl, destfile = paste0(basepath,"data/",dataFile) )

## copy R script in the script folder
scriptFile <- "sampleScript.R"
fileUrl = 'https://raw.githubusercontent.com/atno/ExperimentManager/master/sampleScript.R'
